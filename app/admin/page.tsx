        ...
        <div className="bg-gray-800 p-8 rounded-xl shadow-2xl border border-gray-700">
          ...
          <div className="space-y-4">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-white hover:bg-gray-50 text-gray-900 rounded-lg font-medium transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <div className="text-center text-sm text-gray-500">
              <p>Admin access requires Google SSO authentication.</p>
